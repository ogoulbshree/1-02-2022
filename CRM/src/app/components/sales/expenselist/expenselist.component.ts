...
export class ExpenselistComponent1  extends DynamicComponent implements OnInit {
  ...
  constructor( private _router: Router, private _activatedRoute: ActivatedRoute, injector: Injector,
    public uiService: UiService, private toast: ToastrService,private datepipe: DatePipe,public _uiservice: UiService) { 
  ...
  async onSubmit() {
   // CustomLogger.logStringWithObject("Will save expenseItemDetail...", this.expenseItemDetail);
    ...
    //  CustomLogger.logStringWithObject("expenseItemDetail:result:", result);
      ...
      this._router.navigate(["sales/addexpense"]);
  ...
  onClickEdit(obj) {
    this._router.navigate(['/sales/addexpense', obj.expense_id]);
  }
