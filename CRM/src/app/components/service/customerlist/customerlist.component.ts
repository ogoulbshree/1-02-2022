...
export class CustomerlistComponent extends DynamicComponent implements OnInit {
   ...
   customerDetailsCount: number = 0;
    constructor(private _router: Router, private datePipe: DatePipe,private modalService: NgbModal,injector: Injector,
  ...
  filterData() {
    ...
    async generateCsv(){
      ...
      this.downloadFile(result["data"], 'customerlist');
      }
