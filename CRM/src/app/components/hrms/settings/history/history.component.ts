...
reverse :boolean =false;
    ...
    date = new Date;
  constructor( 
    private datePipe: DatePipe,injector: Injector, public _uiservice:UiService,private toast: ToastrService,private datepipe: DatePipe) { 
      super(GlobalConstants.HRMS_COMPONENT_NAMES.HRMS_HISTORY,injector) 
    }
